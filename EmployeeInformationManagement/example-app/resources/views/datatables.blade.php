...
<html>
  <head>
    <title>Minimal 1.3 - DataTables</title>
...
datatables    <link rel="stylesheet" href="assets/js/vendor/datatables/css/dataTables.bootstrap.css">
  ...
  <body class="bg-1">
      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav refresh">
              <li class="divided">
                <a href="datatables.html#" class="page-refresh"><i class="fa fa-refresh"></i></a>
              </li>
            </ul>
            <!-- /Page refresh -->
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <a class="dropdown-toggle button" data-toggle="dropdown" href="datatables.html#">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li><a href="datatables.html#">Check all tasks <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li>
                    <a class="cyan" href="datatables.html#">
                  ...
                  <li>
                    <a class="green" href="datatables.html#">
                      <div class="profile-photo">
                  ...
                  <li>
                    <a class="red" href="datatables.html#">
                      <div class="profile-photo">
                  ...
                  <li>
                    <a class="orange" href="datatables.html#">
                      <div class="profile-photo">
                  ...
                  <li class="topborder"><a href="datatables.html#">Check all messages <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li>
                   ...
                   <li><a href="datatables.html#">Check all notifications <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided user" id="current-user">
                ...
                <a class="dropdown-toggle options" data-toggle="dropdown" href="datatables.html#">
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    ...
                    <h3>Backgrounds:</h3>
                    <ul id="color-schemes">
                      <li><a href="datatables.html#" class="bg-1"></a></li>
                      <li><a href="datatables.html#" class="bg-2"></a></li>
                      <li><a href="datatables.html#" class="bg-3"></a></li>
                      <li><a href="datatables.html#" class="bg-4"></a></li>
                      <li><a href="datatables.html#" class="bg-5"></a></li>
                      <li><a href="datatables.html#" class="bg-6"></a></li>
                      <li class="title">Solid Backgrounds:</li>
                      <li><a href="datatables.html#" class="solid-bg-1"></a></li>
                      <li><a href="datatables.html#" class="solid-bg-2"></a></li>
                      <li><a href="datatables.html#" class="solid-bg-3"></a></li>
                      <li><a href="datatables.html#" class="solid-bg-4"></a></li>
                      <li><a href="datatables.html#" class="solid-bg-5"></a></li>
                      <li><a href="datatables.html#" class="solid-bg-6"></a></li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul id="videobackgrounds">
                      ...
                      <li><a href="datatables.html#" class="video-bg-1"></a></li>
                      <li><a href="datatables.html#" class="video-bg-2"></a></li>
                      <li><a href="datatables.html#" class="video-bg-3"></a></li>
                      <li><a href="datatables.html#" class="video-bg-4"></a></li>
                      <li><a href="datatables.html#" class="video-bg-5"></a></li>
                      <li><a href="datatables.html#" class="video-bg-6"></a></li>
                      <li><a href="datatables.html#" class="video-bg-7"></a></li>
                      <li><a href="datatables.html#" class="video-bg-8"></a></li>
                      <li><a href="datatables.html#" class="video-bg-9"></a></li>
                      <li><a href="datatables.html#" class="video-bg-10"></a></li>
                    </ul>
                  ...
                  <li>
                    <a href="datatables.html#"><i class="fa fa-user"></i> Profile</a>
                  </li>

                  <li>
                    <a href="datatables.html#"><i class="fa fa-calendar"></i> Calendar</a>
                  </li>

                  <li>
                    <a href="datatables.html#"><i class="fa fa-envelope"></i> Inbox <span class="badge badge-red" id="user-inbox">3</span></a>
                  </li>

                  <li class="divider"></li>

                  <li>
                    <a href="datatables.html#"><i class="fa fa-power-off"></i> Logout</a>
                  </li>
                </ul>
              </li>

              <li>
                <a href="datatables.html#mmenu"><i class="fa fa-comments"></i></a>
              </li>
            </ul>
            <!-- /Quick Actions -->
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="datatables.html#" class="sidebar-toggle" data-toggle="#navigation">Navigation <i class="fa fa-angle-up"></i></a>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 1.1</a></li>

                      <li class="dropdown">
                        <a href="datatables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.2 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            <a href="datatables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 2.3 <b class="fa fa-plus dropdown-plus"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li class="dropdown">
                                <a href="datatables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 3.3 <b class="fa fa-plus dropdown-plus"></b></a>
                                <ul class="dropdown-menu">
                                  <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 4.1</a></li>
                                   <li class="dropdown">
                                      <a href="datatables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 4.2 <b class="fa fa-plus dropdown-plus"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 5.1</a></li>
                                        <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 5.2</a></li>
                                      </ul>
                                    </li>
                                </ul>
                              </li>
                      ...
                      <li class="dropdown">
                        <a href="datatables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.3 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li><a href="datatables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
              ...
              <li class="summary" id="order-summary">
                <a href="datatables.html#" class="sidebar-toggle underline" data-toggle="#order-summary">Orders Summary <i class="fa fa-angle-up"></i></a>

                <div class="media">
                  <a class="pull-right" href="datatables.html#">
              ...
              <li class="settings" id="general-settings">
                <a href="datatables.html#" class="sidebar-toggle underline" data-toggle="#general-settings">General Settings <i class="fa fa-angle-up"></i></a>
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-lightbulb-o" style="line-height: 48px;padding-left: 0;"></i> DataTables <span>// Place subtitle here...</span></h2>
              ...
              <div class="col-md-12">
                ...
                <section class="tile transparent">
                  ...
                  <div class="tile-header transparent">
                    ...
                    <div class="controls">
                      <a href="datatables.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="datatables.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="datatables.html#" class="remove"><i class="fa fa-times"></i></a>
                    </div>
                  </div>
                  <!-- /tile header -->
                      ...
                      <table  class="table table-datatable table-custom" id="inlineEditDataTable">
                        ...
                        <tbody>
                          <tr class="odd gradeX">
                            ...
                            <td class="text-center"> 4</td>
                            <td class="text-center">X</td>
                            <td class="actions text-center"><a class="edit" href="datatables.html#">Edit</a><a class="delete" href="datatables.html#">Delete</a></td>
                          </tr>
                          <tr class="even gradeC">
                            <td>Trident</td>
        ...
        <div id="mmenu" class="right-panel">
          ...
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="datatables.html#mmenu-users" data-toggle="tab"><i class="fa fa-users"></i></a></li>
            <li class=""><a href="datatables.html#mmenu-history" data-toggle="tab"><i class="fa fa-clock-o"></i></a></li>
            <li class=""><a href="datatables.html#mmenu-friends" data-toggle="tab"><i class="fa fa-heart"></i></a></li>
            <li class=""><a href="datatables.html#mmenu-settings" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="datatables.html#">
    ...
    $(function(){
      ...
      var deleteRowLink = '<a href="datatables.html#" id="deleteRow" class="btn btn-red btn-xs delete-row">Delete selected row</a>'
      ...
      function editRow (oTable02, nRow){
        ...
        jqTds[5].innerHTML = '<a class="edit save" href="datatables.html#">Save</a><a class="delete" href="datatables.html#">Delete</a>';
      };
      ...
      function saveRow (oTable02, nRow){
        ...
        oTable02.fnUpdate( '<a class="edit" href="datatables.html#">Edit</a><a class="delete" href="datatables.html#">Delete</a>', nRow, 5, false );
        oTable02.fnDraw();
      };
      ...
      var addRowLink = '<a href="datatables.html#" id="addRow" class="btn btn-green btn-xs add-row">Add row</a>'
      ...
      $('#addRow').click( function (e) {
        ...
        var aiNew = oTable02.fnAddData([ '', '', '', '', '', '<a class="edit" href="datatables.html">Edit</a>', '<a class="delete" href="datatables.html">Delete</a>' ]);
        ...
        "aoColumns": [
          {
            ...
            "sDefaultContent": '<a href="datatables.html#"><i class="fa fa-plus"></i></a>'
          },
          { "mDataProp": "engine" },
          { "mDataProp": "browser" },
          { "mDataProp": "grade" }
